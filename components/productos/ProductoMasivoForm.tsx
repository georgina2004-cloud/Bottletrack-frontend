...
interface ProductoMasivoFormProps {
  onSuccess?: () => void;
}

export function ProductoMasivoForm({ onSuccess }: ProductoMasivoFormProps) {
      ...
      <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 text-xs text-slate-600 flex items-start gap-2.5">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[11px] text-slate-500">
            Campos obligatorios: <strong>Nombre</strong>, <strong>Categoría</strong>,{" "}
            <strong>Precio Compra</strong>, <strong>Precio Venta</strong> y{" "}
            <strong>Stock</strong>. Puedes usar el botón de copiar{" "}
            <Copy className="w-3 h-3 inline text-slate-400" /> para duplicar una fila con sus valores base y acelerar la carga.
          </p>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse min-w-[1050px]">
            <thead>
              <tr className="bg-slate-50/80 border-b border-slate-200/80 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                ...
                <th className="py-3 px-3 min-w-[140px]">Marca / Destilería</th>
        ...
        <div className="p-3 bg-slate-50/70 border-t border-slate-200/80 flex flex-wrap items-center justify-between gap-3 text-xs text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabled={isSaving}
              className="text-xs font-semibold gap-1.5 bg-white shadow-2xs hidden md:inline-flex"
            >
          ...
          <span className="font-medium text-slate-600">
            ...
            <strong className="text-slate-900 font-bold">{filas.length}</strong>
          </span>
        </div>
      </div>
